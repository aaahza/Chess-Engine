        ...
        def knight_moves():
            ...
            for possible_move in possible_moves:
                ...
                if Square.in_range(possible_possible_move_row, possible_move_col):
                    if self.squares[possible_possible_move_row][
                        possible_move_col
                    ].isempty_or_rival(piece.color):
                        # create squares of new move
                        initial = Square(row, col)
                        final = Square(
                            possible_possible_move_row, possible_move_col
                        )  # piece = piece
                        # create new move
                        move = Move(initial, final)
            ...
            for incr in incrs:
                ...
                while True:
                    if Square.in_range(possible_move_row, possible_move_col):
                        ...
                        intital = Square(row, col)
                        final = Square(possible_move_row, possible_move_col)
                        # create a new move
                        move = Move(intital, final)
                        ...
                        # has rival piece = add move and break
                        if self.squares[possible_move_row][
                            possible_move_col
                        ].has_rival_piece(piece.color):
                            # append a new move
